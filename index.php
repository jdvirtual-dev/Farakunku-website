...
<section class="text-center dark-grey-text">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-12 mb-4">
        ...
        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FFarakunkuLodges%2F&tabs=timeline%2C%20events%2C%20messages&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=true&show_facepile=true&appId"  height="500" width="340" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media" adapt_container_width="true"></iframe> </div>    
    </div>
    <!--facebook-->
      ...
      <div id="TA_selfserveprop345" class="TA_selfserveprop" style="height: 100%; width: 100%;">
        <ul id="KXVOd9x" class="TA_links Bm5HWQBwXN" style="height: 100%; width: 100%;">
          <li id="PQMtFBG71D" class="kcqF5Biz">
            <a target="_blank" href="https://www.tripadvisor.co.uk/Hotel_Review-g6510433-d1463453-Reviews-Farakunku_Lodges-Tujereng_West_Coast_Division.html">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          ...
          <div class="row">
            ...
            <!--First column-->
            <div class="col-lg-3 col-md-6 d-flex align-items-center justify-content-center"><div id="TA_rated864" class="TA_rated"><ul id="tGqD4NYIQ" class="TA_links QhjpOP"><li id="PEl1Sgpi" class="n7unR6J7lNz"><a target="_blank" href="https://www.tripadvisor.co.uk/Hotel_Review-g6510433-d1463453-Reviews-Farakunku_Lodges-Tujereng_West_Coast_Division.html"><img src="https://www.tripadvisor.co.uk/img/cdsi/img2/badges/ollie-11424-2.gif" alt="TripAdvisor"/></a></li></ul></div><script async src="https://www.jscache.com/wejs?wtype=rated&amp;uniq=864&amp;locationId=1463453&amp;lang=en_UK&amp;display_version=2" data-loadtrk onload="this.loadtrk=true"></script></div>
            <!--/First column-->
